...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_NAME = "GroceryItems";
    ...
    public long insertItem(String name, double cost) {
    ...
    public double getItemCost(String name) {
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.query(TABLE_NAME, new String[]{COLUMN_COST}, COLUMN_NAME + "=?", new String[]{name}, null, null, null);
        double cost = 0;
        if (cursor.moveToFirst()) {
